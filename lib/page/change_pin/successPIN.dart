...
class ChangePINSuccessScreen extends ConsumerStatefulWidget {
  const ChangePINSuccessScreen({super.key});

  @override
  ConsumerState<ChangePINSuccessScreen> createState() => _successScreenState();
}

class _successScreenState extends ConsumerState<ChangePINSuccessScreen> {
  @override
