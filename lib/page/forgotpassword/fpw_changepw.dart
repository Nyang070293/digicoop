...
class fpw_changePasswordScreen extends ConsumerStatefulWidget {
  ...
  ConsumerState<fpw_changePasswordScreen> createState() =>
      _fpw_changePasswordScreenState();
}

class _fpw_changePasswordScreenState
    extends ConsumerState<fpw_changePasswordScreen> {
  ...
  Future<void> sendData(String newPW, String newCPW) async {
    try {
      ...
      if (response.statusCode == 201) {
        // context.pushReplacementNamed(loadingFPW);
