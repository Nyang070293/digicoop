...
class ChangeFPWSuccessScreen extends ConsumerStatefulWidget {
  const ChangeFPWSuccessScreen({super.key});

  @override
  ConsumerState<ChangeFPWSuccessScreen> createState() => _successScreenState();
}

class _successScreenState extends ConsumerState<ChangeFPWSuccessScreen> {
  @override
                ...
                Container(
                  ...
                  child: Align(
                    ...
                    child: SizedBox(
                      ...
                      height: 247 * fem,
                      child: Image.asset(
                        'assets/images/changePWSuccess.png',
                        width: 328 * fem,
                        height: 247 * fem,
                      ),
                    ),
