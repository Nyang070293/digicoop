                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(
                            'Ensure that all details are correct prior to \nsubmission.',
                            style: SafeGoogleFont(
                              'Montserrat',
                              fontSize: 14 * ffem,
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    GestureDetector(
                                      onTap: () {
                                        setState(() {
                                          _isOfficeAddress = !_isOfficeAddress;
                                        });
                                      },
                                      child: Container(
                                        // bycheckingthisboxiacknowledget (2025:4686)
                                        constraints: BoxConstraints(
                                          maxWidth: 304 * fem,
                                        ),
                                        child: RichText(
